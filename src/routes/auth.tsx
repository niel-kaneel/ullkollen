  ...
  return (
    <div className="min-h-screen flex flex-col px-6 py-8">
      ...
      <div className="flex items-center gap-3 my-6">
        ...
        <span className="text-[11px] uppercase tracking-[0.25em] text-muted-foreground font-semibold">{t("or") ?? "eller"}</span>
        <div className="flex-1 h-px bg-border" />
      </div>
      ...
      <div className="space-y-3">
        <Button
          ...
          className="w-full h-14 text-base rounded-2xl bg-card border-2 gap-3"
        >
          ...
          {mode === "signup" ? (t("continueWithGoogle") ?? "Fortsätt med Google") : (t("signInWithGoogle") ?? "Logga in med Google")}
        </Button>
        <Button
          type="button"
          variant="outline"
        ...
        >
          ...
          {mode === "signup" ? (t("continueWithApple") ?? "Fortsätt med Apple") : (t("signInWithApple") ?? "Logga in med Apple")}
        </Button>
      </div>
